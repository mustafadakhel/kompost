 ...
 */
@TestOnly
public fun mockGlobalFarm(mockFarm: GlobalFarm) {
    globalFarm = mockFarm
}
 ...
 */
public interface GlobalFarm : Producer
 ...
 */
private class DefaultGlobalFarm : GlobalFarm,
    Producer by DefaultProducer(id = GlobalFarmId, parent = null)
 ...
 */
@Synchronized
public fun globalFarm(): GlobalFarm {
